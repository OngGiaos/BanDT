                                                ...
                                                <c:forEach items="${wish}" var="w">
                                                    <c:if test="${w.phone.show==true}">
                                                        <div class="product-widget">
                                                            ...
                                                            <button class="delete"><a href="deleteInWishlist?id=${w.phone.id}&page=detail" class="fa fa-close"></a></button>
                                                        </div>
                                                    </c:if>
                                                </c:forEach>
                                            </div>
                                            ...
                                            <div class="cart-list">
                                                <c:forEach items="${order}" var="o">
                                                    <div class="product-widget">
                                                        ...
                                                        <button class="delete"><a href="deleteInCart?id=${o.phone.id}&page=detail" class="fa fa-close"></a></button>
                                                    </div>
                                                </c:forEach>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="breadcrumb-tree">
                            ...
                            <li class="active">${thisphone.name}</li>
                        </ul>
                    </div>
                </div>
                <!-- /row -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="product-details">
                            <h2 class="product-name">${thisphone.name}</h2>
                            <div>
                            ...
                            <div>
                                <h3 class="product-price">${thisphone.price}VND</h3>

                            </div>
                            <p>${thisphone.information}</p>
                            <br><p>Creator: <a href="#">${thisphone.creator}</a></p>
                            <form action="AddToCart">
                                <input hidden type="text" name="page" value="detail">
                                <input hidden type="text" name="id" value="${thisphone.id}">
                                <div class="add-to-cart">
                                    <div class="qty-label">
                                        Qty
                                        <div class="input-number">
                                            <input required type="number" min="1" max="${thisphone.quantity}" name="quantity" value="1">
                                    ...
                                    <br>
                                    <c:choose>
                                        <c:when test="${user!=null&&thisphone.quantity>0&&thisphone.show==true}">
                                            <br><button type="submit" name="addCart" value="ok" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button>
                                            <button class="add-to-cart-btn"><i class="fa fa-heart-o"></i><a href="AddToWishlist?id=${thisphone.id}&quantity=1&page=detail">add to wishlist</a></button>
                                                </c:when>
                                                <c:when test="${user!=null&&thisphone.quantity>0&&thisphone.show==false}">
                                            <br><button class="add-to-cart-btn"><i class="fa fa-close"></i>sold out</button>
                                            <button class="add-to-cart-btn"><i class="fa fa-heart-o"></i><a href="AddToWishlist?id=${thisphone.id}&quantity=1&page=detail">add to wishlist</a></button>
                                                </c:when>
                                                <c:when test="${user!=null&&thisphone.quantity<1}">
                                            <br><button class="add-to-cart-btn"><i class="fa fa-close"></i>sold out</button>
                                            <button class="add-to-cart-btn"><i class="fa fa-heart-o"></i><a href="AddToWishlist?id=${thisphone.id}&quantity=1&page=detail">add to wishlist</a></button>
                                                </c:when>
                                                <c:when test="${thisphone.quantity<1}">
                                            <br><button class="add-to-cart-btn"><i class="fa fa-close"></i>sold out</button>
                                            <button class="add-to-cart-btn"><i class="fa fa-heart-o"></i><a href="Login.jsp">add to wishlist</a></button>
                                                </c:when>
                                                <c:otherwise>
                                            <br><button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="Login.jsp">add to cart</a></button>
                                            <button class="add-to-cart-btn"><i class="fa fa-heart-o"></i><a href="Login.jsp">add to wishlist</a></button>
                                                </c:otherwise>
                                            </c:choose>
                                </div>
                                ...
                                <div id="tab1" class="tab-pane active">
                                    <div class="products-slick" data-nav="#slick-nav-1">
                                        ...
                                        <c:forEach  items="${phone_see}" var="p">
                                            <c:if test="${p.creator.equalsIgnoreCase(thisphone.creator)&&p.id!=thisphone.id&&p.show==true}">
                                                <div class="product">
                                                    <div class="product-img">
                                                        <img src="${p.img}" alt="">
                                                    </div>
